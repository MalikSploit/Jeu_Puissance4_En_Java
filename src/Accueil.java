...
public class Accueil extends JPanel implements ItemListener
{
	 ...
	 */
	public Accueil(Main ctrl)
	{
		// L'attribut renseigne sur le contrôleur.
		...
		// L'attribut renseigne sur le regroupement des boutons.
		...
		this.infosJoueur = new InfosJoueur(ctrl);
		this.chargePartie = new ChargePartie(ctrl);
	...
	/**
	 * Si le joueur sélectionne le bouton radio nouvelle partie 1vs1 ou nouvelle partie 1vsCPU ou charger partie.
	 */
