...
public class GraphiqueAccueil extends JFrame
{
	 ...
	 */
	private final Accueil accueil; // L'attribut renseigne sur l'Accueil.
	 ...
	 */
	public GraphiqueAccueil(Main fenetreEcran, int largeurEcran, int hauteurEcran)
	{
		...
		this.accueil = new Accueil(fenetreEcran);
		this.add(accueil);
