...
public class Grille implements Serializable
{
	...
	private final char[][]      grille; 					// L'attribut renseigne sur la grille de Puissance4.
	...
	/**
	 * initGrille : Initialise la grille et connecte chaque case avec toutes les cases à côté d'elle.
	 */
	...
	public Grille(String nomJeu)
	{
		...
		this.grille             = new char[this.nbLigne][this.nbColonne];   // Création d'une grille avec le nombre de lignes 6 le nombre de colonnes 7.
